...
load nondiffusing 
power=cat(3,abs(P_floor1)+abs(P_floor_diffu_1),abs(P_floor2)+abs(P_floor_diffu_2),...
...
nondif_ekf_nlos=[mean_rmse1 mean_rmse2 mean_rmse3 mean_rmse4...
                     mean_rmse5 mean_rmse6 mean_rmse7 mean_rmse8];
non_dif_ci_nlos=[CI1; CI2; CI3; CI4; CI5; CI6; CI7; CI8];

save nondiffusing_lamp_decimeters_ekf_los_nlos nondif_ekf_nlos non_dif_ci_nlos
...
plot(SNR,nondif_ekf_nlos,'-*',...
    'linewidth',2,'Markersize',10)
title('Nondiffusing, EKF, NLOS')
xlabel('SNR (dB)')
ylabel('RMSE (dm)')
legend('True RMSE')
toc                      